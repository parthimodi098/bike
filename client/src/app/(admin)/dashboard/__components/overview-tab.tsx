...
export default function OverviewTab() {
  ...
  const statCards = [
    ...
    },
    {
      ...
      value: (stats?.totalMotorcycles || 0).toString(),
      icon: Bike,
      change: "+2",
        ...
        <Card className="bg-yellow-50 border-yellow-200">
          <CardContent className="p-4">
            ...
            <p className="text-sm text-yellow-700 mt-1">
              Users: {stats.totalUsers || 0} total ({stats.totalCustomers || 0} customers, {(stats.totalUsers || 0) - (stats.totalCustomers || 0)} admins/staff)
            </p>
          </CardContent>
        </Card>
      )}
